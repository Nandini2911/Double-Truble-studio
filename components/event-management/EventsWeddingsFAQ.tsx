...
export default function EventsWeddingsFAQs() {
  ...
  return (
    <section
      ...
      "
    >
      {/* premium grid + extra glows (same family as Guest/Celebrity FAQ style) */}
      <div
        className="pointer-events-none absolute inset-0 opacity-[0.08]
        bg-[linear-gradient(to_right,rgba(255,255,255,0.06)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.06)_1px,transparent_1px)]
        bg-[size:160px_160px]"
      />
      <div className="pointer-events-none absolute inset-0 opacity-[0.06] bg-[radial-gradient(circle_at_20%_10%,rgba(255,63,164,0.14),transparent_55%)]" />
      <div className="pointer-events-none absolute inset-0 opacity-[0.04] bg-[radial-gradient(circle_at_80%_80%,rgba(216,184,115,0.12),transparent_60%)]" />
      ...
      >
        ...
        {/* FAQ list (glass cards like your Guest FAQ design) */}
        <div className="mt-16">
          {faqs.map((f, i) => {
