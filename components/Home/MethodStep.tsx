...
export default function MethodSteps() {
  return (
    <section className="py-8 md:py-10 px-4 md:px-6 lg:px-8 xl:px-0">
      ...
      <motion.div
        ...
        className="mx-auto w-full max-w-6xl 2xl:max-w-[1500px] space-y-6 md:space-y-8"
      >
        ...
        <div className="relative">
          ...
          <div className="space-y-4 md:space-y-5">
            {STEPS.map((step, index) => (
              <div key={step.label} className="relative pl-0 md:pl-10">
