      ...
      <div className="relative grid md:grid-cols-2 gap-12 w-full max-w-7xl mx-auto items-center">
        ...
        <div>
          ...
          <p className="mt-6 text-gray-100 max-w-lg">
            Double Trouble Studio helps brands across India build visibility,
            trust and premium positioning through PR, digital marketing, web
            and events.
          </p>
        ...
        <div className="dts-card-3d p-6 md:p-7 max-w-md ml-auto backdrop-blur-xl bg-white/5">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="dts-btn-primary w-full py-3 text-sm font-semibold"
            >
          ...
          {/* TAGLINE */}
          <div className="mt-4 text-[10px] uppercase tracking-[0.18em] text-neutral-400">
