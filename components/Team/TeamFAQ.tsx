...
const faqs = [
  {
    q: "Who makes up the DTS team?",
    a: "Our team is a curated group of designers, developers, and strategists working together to build high-quality digital systems with precision and consistency.",
  },
  {
    q: "Do you have in-house experts or outsource work?",
    a: "Core strategy, design, and execution are handled in-house to maintain quality and control. We only collaborate externally when it adds specific value.",
  },
  {
    q: "Who will I be working with directly?",
    a: "You’ll work with a focused team aligned to your project, led by a central point of contact to ensure smooth communication and clarity.",
  },
  {
    q: "How experienced is your team?",
    a: "Our team brings experience across branding, development, and growth systems, with a strong focus on building premium, high-performing digital experiences.",
  },
  {
    q: "How does your team ensure quality?",
    a: "We follow a structured process with clear checkpoints, reviews, and refinement cycles to ensure everything meets our standards before delivery.",
  },
];
