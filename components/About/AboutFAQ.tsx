...
const faqs = [
  {
    q: "What is DTS and what do you actually do?",
    a: "DTS is a premium digital growth and branding company. We design, build, and scale complete digital ecosystems — combining strategy, design, development, and marketing into one unified system.",
  },
  {
    q: "What makes DTS different from other agencies?",
    a: "Most agencies deliver isolated services. We build connected systems. Every element — from brand identity to website to marketing — is designed to work together, ensuring consistency and stronger performance.",
  },
  {
    q: "Who do you typically work with?",
    a: "We work with founders, personal brands, and businesses that want a premium presence and long-term growth. Our focus is on clients who value strategy, quality, and execution.",
  },
  {
    q: "Do you offer custom solutions or fixed packages?",
    a: "Everything is tailored. We don’t follow one-size-fits-all packages. Each project is built around your goals, audience, and positioning.",
  },
  {
    q: "Can you handle everything end-to-end?",
    a: "Yes. From brand identity and website development to marketing systems and scaling, we manage the entire process so you don’t need multiple vendors.",
  },
  {
    q: "How do we get started?",
    a: "It begins with a consultation. We understand your goals, map a strategy, and then move into execution with a clear plan.",
  },
];
