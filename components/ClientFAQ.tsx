...
const faqs = [
  {
    ...
    a: "We partner with founders, premium brands, and businesses that value strategy, design, and long-term growth over quick, short-term fixes.",
  },
  {
    q: "What is it like working with DTS?",
    a: "Structured, transparent, and strategic. We guide you through every stage — from planning to execution — with clear communication and attention to detail.",
  },
  {
    q: "Do you take on all projects?",
    a: "No. We selectively work with clients where we can create real impact. This allows us to maintain focus, quality, and strong results.",
  },
  {
    q: "How involved do I need to be?",
    a: "We handle execution end-to-end, while involving you at key decision points to ensure alignment with your vision and goals.",
  },
  {
    q: "How do you ensure consistency and quality?",
    a: "Everything is built as a connected system — ensuring your brand remains consistent across design, development, and marketing.",
  },
  {
    q: "What results can I expect?",
    a: "Stronger brand positioning, improved user experience, and scalable growth systems. Results depend on your goals and execution scope.",
  },
  {
    q: "How do we start working together?",
    a: "We begin with a consultation to understand your business, identify opportunities, and create a tailored strategy before execution.",
  },
];
