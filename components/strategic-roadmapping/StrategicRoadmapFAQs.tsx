...
const faqs = [
  {
    q: "How is a strategic roadmap priced?",
    a: "Pricing depends on the scope, complexity, and level of detail required for your business's strategic roadmap. After discussing your needs, we provide a tailored quote that includes research, planning, and execution phases.",
  },
  {
    q: "When should we start working on our roadmap?",
    a: "It's ideal to start early, at least 2–3 months before execution. The earlier we begin, the better we can align the strategy with market trends and your business goals. For larger organizations or complex strategies, more time is recommended.",
  },
  {
    q: "What’s included in a strategic roadmap?",
    a: "A roadmap includes market research, competitive analysis, goal setting, detailed action plans, timelines, and KPIs. We also provide resource allocation strategies, budget breakdowns, and risk management plans.",
  },
  {
    q: "Can we customize the roadmap process?",
    a: "Yes, every roadmap is designed according to your business needs. We customize it based on your industry, objectives, target market, and existing resources, ensuring it's tailored to your specific goals.",
  },
  {
    q: "How do you ensure the roadmap is executable?",
    a: "We work with your team to create a roadmap that's actionable and realistic. We focus on clear, measurable steps, achievable milestones, and a structure that can be adapted for unforeseen challenges.",
  },
];

export default function StrategicRoadmapFAQs() {
  ...
  <span className="text-transparent bg-clip-text bg-gradient-to-r from-dts-neon via-dts-neon-pink to-dts-gold">
    Questions, answered.
          ...
          <p className="mx-auto mt-4 max-w-2xl text-[14px] leading-relaxed text-neutral-200/80">
            Pricing, timelines, scope, customisation — clarified upfront.
          </p>
        </motion.div>

        {/* FAQ list (Celebrity FAQ style cards) */}
        <div className="mt-16">
          {faqs.map((f, i) => {
        ...
        >
          <p className="text-[14px] leading-relaxed text-neutral-200/80">
            Still unsure? Let’s walk through your goals and map the right roadmap.
          </p>
