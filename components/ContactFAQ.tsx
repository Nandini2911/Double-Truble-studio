...
const faqs = [
  {
    q: "How do I get started with DTS?",
    a: "Simply fill out the contact form or reach out to us directly. We’ll review your requirements and schedule a consultation to understand your goals.",
  },
  {
    q: "How soon will I get a response?",
    a: "We typically respond within 24 hours. For urgent inquiries, we aim to get back even sooner.",
  },
  {
    q: "Do you work with clients worldwide?",
    a: "Yes. We collaborate with clients globally and manage communication seamlessly across different time zones.",
  },
  {
    q: "What information should I provide when contacting you?",
    a: "Sharing details about your business, goals, and what you're looking to achieve helps us understand your needs and provide a more accurate direction.",
  },
  {
    q: "Is there an initial consultation fee?",
    a: "No. The initial consultation is completely free and focused on understanding your requirements and exploring the right approach.",
  },
  {
    q: "What happens after I submit the form?",
    a: "We review your submission, get in touch to discuss your project, and then outline the next steps with a clear strategy and execution plan.",
  },
];
