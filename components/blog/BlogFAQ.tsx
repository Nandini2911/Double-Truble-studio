...
const faqs = [
  {
    q: "What kind of content do you publish on the blog?",
    a: "We share insights on branding, digital growth, design systems, and marketing strategies — focused on helping businesses build stronger, more premium digital presence.",
  },
  {
    q: "Who is this blog for?",
    a: "This blog is for founders, creators, and businesses looking to understand how to grow their brand strategically in today’s digital landscape.",
  },
  {
    q: "Are your articles based on real experience?",
    a: "Yes. Every article is built from practical insights, real-world execution, and proven strategies we apply in actual client projects.",
  },
  {
    q: "How often do you publish new content?",
    a: "We focus on quality over quantity. New articles are published regularly with a strong emphasis on depth, clarity, and value.",
  },
  {
    q: "Can I apply these strategies to my business?",
    a: "Absolutely. Our content is designed to be actionable, giving you clear direction you can implement or scale with the right systems.",
  },
  {
    q: "Do you offer services related to these topics?",
    a: "Yes. The strategies we share in our blog are the same frameworks we use in our services — adapted and executed based on each client’s goals.",
  },
];
